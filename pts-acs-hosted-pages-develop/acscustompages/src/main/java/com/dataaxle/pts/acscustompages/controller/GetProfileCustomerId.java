...
@Slf4j
@Controller
@RequestMapping(value = ControllerUtils.GET_PROFILE_CUSTOMERID_PATH)
public class GetProfileCustomerId {
	...
	@Autowired
	public GetProfileCustomerId(ViewNameService viewNameService, GetProfileCustomerIdService getProfileCustomerIdService,
